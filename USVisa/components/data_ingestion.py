...
class DataIngestion:
    ...
    def export_data_to_feature_store(self) -> DataFrame:
        ...
        """
        try:
            logging.info("Exporting the data from Mongo DB")
            usvisa = USvisaData()
            dataframe = usvisa.export_collection_as_dataframe(collection_name=
    ...
    def split_data_as_train_and_test(self, dataframe: DataFrame) -> None:
        ...
        try:
            ...
            logging.info(f"Exported data to train and test file path")
