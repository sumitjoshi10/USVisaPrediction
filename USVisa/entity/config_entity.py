...
class DataIngestionConfig:
    ...
    Description :   This class has all the filepath required for the Data Ingestion
    '''
...
class DataTransformationConfig:
    ...
    Description :   This class has all the filepath required for the Data Transformation
    '''
